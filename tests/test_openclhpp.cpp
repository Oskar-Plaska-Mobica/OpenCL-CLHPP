...
//cl_int clCreateSubDevicesEXT_testDevice_createSubDevices (cl_device_id in_device, const cl_device_partition_property_ext* properties,
//cl_uint num_entries, cl_device_id* out_devices, cl_uint* num_devices, cl_int cmock_to_return)
//{
//    //char *a = {"oo"};
//    return 0;
//}
...
static cl_int clGetDeviceInfo_testDevice_createSubDevices(cl_device_id id,
                                            cl_device_info param_name,
                                            size_t param_value_size,
                                            void *param_value,
                                            size_t *param_value_size_ret,
...
static cl_int clCreateSubDevices_testDevice_createSubDevices(cl_device_id                         in_device,
...
cl_int pfn_clCreateSubDevicesEXT_testDevice_createSubDevices(cl_device_id device_in, cl_device_partition_property_ext properties, cl_int n, cl_device_id out_devices, cl_int* num)
{
    cl_int ret = CL_SUCCESS;
...
{
    const cl_device_partition_property_ext properties = CL_DEVICE_PARTITION_TYPES_EXT;
    std::vector<cl::Device> devices;
    cl_platform_id platform = make_platform_id(0);
    
    clGetPlatformInfo_StubWithCallback(clGetPlatformInfo_testDevice_createSubDevices);
    clGetDeviceInfo_StubWithCallback(clGetDeviceInfo_testDevice_createSubDevices);
    clCreateSubDevices_StubWithCallback(clCreateSubDevices_testDevice_createSubDevices);
    clGetExtensionFunctionAddressForPlatform_ExpectAndReturn(platform, "clCreateSubDevicesEXT", &pfn_clCreateSubDevicesEXT_testDevice_createSubDevices);
